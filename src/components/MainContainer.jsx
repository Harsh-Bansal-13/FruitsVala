      ...
      <section className="w-full my-5">
        <div className="w-full flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-3 items-center">
            <motion.div
              whileTap={{ scale: 0.75 }}
              className="w-8 h-8 rounded-lg bg-orange-400 hover:bg-orange-500 flex cursor-pointer transition-all ease-in-out hover:shadow-lg items-center justify-center "
            >
              <MdChevronLeft className="text-lg text-white"></MdChevronLeft>
            </motion.div>
            <motion.div
              whileTap={{ scale: 0.75 }}
              className="w-8 h-8 rounded-lg flex bg-orange-400 hover:bg-orange-500 items-center justify-center cursor-pointer transition-all ease-in-out hover:shadow-lg"
            >
